...
const EditRealtors:React.FC<EditRealtorsProps> = ({modal, setModal, editData}) => {
	...
	const onSubmit = async (values: any, { resetForm }: any) => {
		...
		try {
			await RealtorsServices.editRealtor(editData.id, formData);
			...
			toastError('Error al Editar Asesor');
		}
	};
	...
	return (
		<Modal
			...
			<Formik
				...
				validationSchema={validationSchema.editRealtor}
				onSubmit={onSubmit}>
